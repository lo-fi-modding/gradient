...
public abstract class ProcessorTileOld<Recipe extends IRecipe<?>, Source extends IEnergySource, Processor extends IProcessor<Recipe>> extends TileEntity implements ITickableTileEntity {
  private final Source energy;
  private final Processor processor;
  private Recipe recipe;

  public ProcessorTileOld(final TileEntityType<?> type, final Source energy, final Processor processor) {
    super(type);
    this.energy = energy;
