...
public class CookingRecipeCategory implements IRecipeCategory<CookingRecipe> {
  ...
  public void draw(final CookingRecipe recipe, final double mouseX, final double mouseY) {
    ...
    font.drawString(I18n.format("jei.cooking.temperature", recipe.temperature), 1, 22, 0x404040);
    font.drawString(I18n.format("jei.cooking.ticks", recipe.ticks), 1, 35, 0x404040);
  ...
  @Override
  public List<String> getTooltipStrings(final CookingRecipe recipe, final double mouseX, final double mouseY) {
