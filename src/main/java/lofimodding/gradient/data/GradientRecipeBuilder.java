...
public final class GradientRecipeBuilder {
  ...
  public static class Grinding {
    ...
    private Grinding(final IItemProvider item, final int amount) {
    ...
    public static class Result implements IFinishedRecipe {
      ...
      private Result(final ResourceLocation id, final Set<Stage> stages, final int ticks, final Item result, final int count, final String group, final List<Ingredient> ingredients, final Advancement.Builder advancementBuilder, final ResourceLocation advancementId) {
        this.id = id;
        this.stages = stages;
        this.ticks = ticks;
        this.result = result;
  ...
  public static class Cooking {
    ...
    private Cooking(final IItemProvider item, final int amount) {
      this.result = item.asItem();
      this.count = amount;
    }
    ...
    public static class Result implements IFinishedRecipe {
      ...
      private Result(final ResourceLocation id, final Set<Stage> stages, final int ticks, final float temperature, final Item result, final int count, final String group, final List<Ingredient> ingredients, final Advancement.Builder advancementBuilder, final ResourceLocation advancementId) {
        this.id = id;
        this.stages = stages;
        this.ticks = ticks;
        this.temperature = temperature;
