...
public final class ModelGenerator {
  ...
  public static void mechanicalGrindstone(final GradientDataGenerator.BlockModels generator, final String id, final ResourceLocation particle, final ResourceLocation surface, final ResourceLocation casing, final ResourceLocation frame) {
    generator.getBuilder(id)
      .parent(generator.getExistingFile(generator.mcLoc("block/block")))
      .texture("particle", particle)
      ...
      .from(6.0f, 1.0f, 2.0f)
      .to(10.5f, 3.0f, 14.0f)
      .rotation().angle(-22.5f).axis(Direction.Axis.Z).origin(7.0f, 8.5f, 8.0f).end()
      .face(Direction.NORTH).uvs(0.0f, 0.0f, 5.0f, 2.0f).texture("surface").end()
      .face(Direction.EAST).uvs(0.0f, 0.0f, 12.0f, 2.0f).texture("surface").end()
      .face(Direction.SOUTH).uvs(0.0f, 0.0f, 5.0f, 2.0f).texture("surface").end()
      .face(Direction.WEST).uvs(0.0f, 0.0f, 12.0f, 2.0f).texture("surface").end()
      .face(Direction.UP).uvs(0.0f, 2.0f, 5.0f, 14.0f).texture("surface").end()
      .face(Direction.DOWN).uvs(0.0f, 0.0f, 5.0f, 12.0f).texture("surface").end()
      .end()

      .element() // surface 2
      .from(5.5f, 1.0f, 2.0f)
      .to(10.0f, 3.0f, 14.0f)
      .rotation().angle(22.5f).axis(Direction.Axis.Z).origin(9.0f, 8.5f, 8.0f).end()
      .face(Direction.NORTH).uvs(0.0f, 0.0f, 5.0f, 2.0f).texture("surface").end()
      .face(Direction.EAST).uvs(2.0f, 0.0f, 14.0f, 2.0f).texture("surface").end()
      .face(Direction.SOUTH).uvs(0.0f, 0.0f, 5.0f, 2.0f).texture("surface").end()
      .face(Direction.WEST).uvs(0.0f, 0.0f, 12.0f, 2.0f).texture("surface").end()
      .face(Direction.UP).uvs(11.0f, 2.0f, 16.0f, 14.0f).texture("surface").end()
      .face(Direction.DOWN).uvs(0.0f, 0.0f, 5.0f, 12.0f).texture("surface").end()
      .end()
      ...
      .from(4.0f, 0.0f, 0.0f)
      .to(12.0f, 4.0f, 2.0f)
      .face(Direction.NORTH).uvs(4.0f, 12.0f, 12.0f, 16.0f).texture("casing").end()
      .face(Direction.EAST).uvs(0.0f, 0.0f, 1.0f, 3.0f).texture("casing").end()
      .face(Direction.SOUTH).uvs(4.0f, 13.0f, 12.0f, 16.0f).texture("casing").end()
      .face(Direction.WEST).uvs(0.0f, 0.0f, 1.0f, 3.0f).texture("casing").end()
      .face(Direction.UP).uvs(4.0f, 0.0f, 12.0f, 2.0f).texture("casing").end()
      .face(Direction.DOWN).uvs(4.0f, 0.0f, 12.0f, 2.0f).texture("casing").end()
      .end()
      ...
      .face(Direction.UP).uvs(12.0f, 0.0f, 14.0f, 16.0f).texture("casing").end()
      .face(Direction.DOWN).uvs(2.0f, 0.0f, 4.0f, 16.0f).texture("casing").end()
      .end()
      ...
      .face(Direction.UP).uvs(2.0f, 0.0f, 4.0f, 16.0f).texture("casing").end()
      .face(Direction.DOWN).uvs(12.0f, 0.0f, 14.0f, 16.0f).texture("casing").end()
      .end()

      .element() // south
      .from(4.0f, 0.0f, 14.0f)
      .to(12.0f, 4.0f, 16.0f)
      .face(Direction.NORTH).uvs(4.0f, 13.0f, 12.0f, 16.0f).texture("casing").end()
      .face(Direction.EAST).uvs(0.0f, 0.0f, 1.0f, 3.0f).texture("casing").end()
      .face(Direction.SOUTH).uvs(4.0f, 12.0f, 12.0f, 16.0f).texture("casing").end()
      .face(Direction.WEST).uvs(0.0f, 0.0f, 1.0f, 3.0f).texture("casing").end()
      .face(Direction.UP).uvs(4.0f, 14.0f, 12.0f, 16.0f).texture("casing").end()
      .face(Direction.DOWN).uvs(4.0f, 14.0f, 12.0f, 16.0f).texture("casing").end()
      .end()
      ...
      .from(2.0f, 4.0f, 0.0f)
      .to(4.0f, 9.0f, 2.0f)
      .face(Direction.NORTH).uvs(7.0f, 0.0f, 9.0f, 5.0f).texture("frame").end()
      .face(Direction.EAST).uvs(14.0f, 0.0f, 16.0f, 5.0f).texture("frame").end()
      .face(Direction.SOUTH).uvs(7.0f, 0.0f, 9.0f, 5.0f).texture("frame").end()
      .face(Direction.WEST).uvs(0.0f, 0.0f, 2.0f, 5.0f).texture("frame").end()
      .face(Direction.UP).uvs(0.0f, 6.0f, 2.0f, 8.0f).texture("frame").rotation(ModelBuilder.FaceRotation.CLOCKWISE_90).end()
      .face(Direction.DOWN).uvs(0.0f, 0.0f, 2.0f, 2.0f).texture("frame").end()
      .end()

      .element() // leg south
      .from(2.0f, 4.0f, 14.0f)
      .to(4.0f, 9.0f, 16.0f)
      .face(Direction.NORTH).uvs(7.0f, 0.0f, 9.0f, 5.0f).texture("frame").end()
      .face(Direction.EAST).uvs(0.0f, 0.0f, 2.0f, 5.0f).texture("frame").end()
      .face(Direction.SOUTH).uvs(7.0f, 0.0f, 9.0f, 5.0f).texture("frame").end()
      .face(Direction.WEST).uvs(14.0f, 0.0f, 16.0f, 5.0f).texture("frame").end()
      .face(Direction.UP).uvs(14.0f, 6.0f, 16.0f, 8.0f).texture("frame").end()
      .face(Direction.DOWN).uvs(0.0f, 0.0f, 2.0f, 2.0f).texture("frame").end()
      .end()

      .element() // leg north
      .from(12.0f, 4.0f, 14.0f)
      .to(14.0f, 9.0f, 16.0f)
      .face(Direction.NORTH).uvs(7.0f, 0.0f, 9.0f, 5.0f).texture("frame").end()
      .face(Direction.EAST).uvs(0.0f, 0.0f, 2.0f, 5.0f).texture("frame").end()
      .face(Direction.SOUTH).uvs(7.0f, 0.0f, 9.0f, 5.0f).texture("frame").end()
      .face(Direction.WEST).uvs(14.0f, 0.0f, 16.0f, 5.0f).texture("frame").end()
      .face(Direction.UP).uvs(0.0f, 6.0f, 2.0f, 8.0f).texture("frame").rotation(ModelBuilder.FaceRotation.COUNTERCLOCKWISE_90).end()
      .face(Direction.DOWN).uvs(0.0f, 0.0f, 2.0f, 2.0f).texture("frame").rotation(ModelBuilder.FaceRotation.UPSIDE_DOWN).end()
      .end()

      .element() // leg south
      .from(12.0f, 4.0f, 0.0f)
      .to(14.0f, 9.0f, 2.0f)
      .face(Direction.NORTH).uvs(7.0f, 0.0f, 9.0f, 5.0f).texture("frame").end()
      .face(Direction.EAST).uvs(14.0f, 0.0f, 16.0f, 5.0f).texture("frame").end()
      .face(Direction.SOUTH).uvs(7.0f, 0.0f, 9.0f, 5.0f).texture("frame").end()
      .face(Direction.WEST).uvs(0.0f, 0.0f, 2.0f, 5.0f).texture("frame").end()
      .face(Direction.UP).uvs(14.0f, 6.0f, 16.0f, 8.0f).texture("frame").rotation(ModelBuilder.FaceRotation.UPSIDE_DOWN).end()
      .face(Direction.DOWN).uvs(0.0f, 0.0f, 2.0f, 2.0f).texture("frame").rotation(ModelBuilder.FaceRotation.UPSIDE_DOWN).end()
      .end()
      ...
      .from(2.0f, 5.0f, 2.0f)
      .to(4.0f, 6.0f, 14.0f)
      .face(Direction.NORTH).uvs(0.0f, 0.0f, 2.0f, 1.0f).texture("frame").end()
      .face(Direction.EAST).uvs(2.0f, 3.0f, 14.0f, 4.0f).texture("frame").end()
      .face(Direction.SOUTH).uvs(0.0f, 0.0f, 2.0f, 1.0f).texture("frame").end()
      .face(Direction.WEST).uvs(2.0f, 3.0f, 14.0f, 4.0f).texture("frame").end()
      .face(Direction.UP).uvs(2.0f, 7.0f, 14.0f, 9.0f).texture("frame").rotation(ModelBuilder.FaceRotation.CLOCKWISE_90).end()
      .face(Direction.DOWN).uvs(2.0f, 1.0f, 14.0f, 3.0f).texture("frame").rotation(ModelBuilder.FaceRotation.CLOCKWISE_90).end()
      .end()
      ...
      .element() // rod bottom
      .from(12.0f, 5.0f, 2.0f)
      .to(14.0f, 6.0f, 14.0f)
      .face(Direction.NORTH).uvs(0.0f, 0.0f, 2.0f, 1.0f).texture("frame").end()
      .face(Direction.EAST).uvs(2.0f, 3.0f, 14.0f, 4.0f).texture("frame").end()
      .face(Direction.SOUTH).uvs(0.0f, 0.0f, 2.0f, 1.0f).texture("frame").end()
      .face(Direction.WEST).uvs(2.0f, 3.0f, 14.0f, 4.0f).texture("frame").end()
      .face(Direction.UP).uvs(2.0f, 7.0f, 14.0f, 9.0f).texture("frame").rotation(ModelBuilder.FaceRotation.COUNTERCLOCKWISE_90).end()
      .face(Direction.DOWN).uvs(2.0f, 1.0f, 14.0f, 3.0f).texture("frame").rotation(ModelBuilder.FaceRotation.COUNTERCLOCKWISE_90).end()
      .end()

      .element() // rod top
      .from(12.0f, 8.0f, 2.0f)
      .to(14.0f, 9.0f, 14.0f)
      .face(Direction.NORTH).uvs(0.0f, 0.0f, 2.0f, 1.0f).texture("frame").end()
      .face(Direction.EAST).uvs(2.0f, 3.0f, 14.0f, 4.0f).texture("frame").end()
      .face(Direction.SOUTH).uvs(0.0f, 0.0f, 2.0f, 1.0f).texture("frame").end()
  ...
  public static void mechanicalMixingBasin(final GradientDataGenerator.BlockModels generator, final String id, final ResourceLocation particle, final ResourceLocation side, final ResourceLocation top) {
    generator.getBuilder(id)
      ...
      .face(Direction.EAST).uvs(2.0f, 4.0f, 4.0f, 12.0f).texture("top").rotation(ModelBuilder.FaceRotation.CLOCKWISE_90).end()
      .face(Direction.SOUTH).uvs(4.0f, 12.0f, 12.0f, 14.0f).texture("top").end()
      .face(Direction.WEST).uvs(12.0f, 4.0f, 14.0f, 12.0f).texture("top").rotation(ModelBuilder.FaceRotation.COUNTERCLOCKWISE_90).end()
